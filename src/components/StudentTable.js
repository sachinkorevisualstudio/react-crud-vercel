...
const StudentTable = () => {
  ...
  const handleAddStudent = () => {
    axios
      .post('http://kiwisolution1.somee.com/api/Students', newStudent)
      .then((response) => {
  ...
  const handleUpdate = () => {
    ...
    axios
      .put(`http://kiwisolution1.somee.com/api/Students/id?id=${id}`, { id, name })
      .then((response) => {
  ...
  const handleDelete = (id) => {
    axios
      .delete(`http://kiwisolution1.somee.com/api/Students/id?id=${id}`)
      .then(() => {
